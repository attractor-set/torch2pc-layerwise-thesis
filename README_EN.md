...
![Status](https://img.shields.io/badge/stage-matched%20profiling%20sealed%3B%20analysis%20closed-blue)
...
The next incomplete step is the evidence PR, green CI, a draft release with run
artifacts, and a separate analysis-opening checkpoint. Evidence preservation
does not authorize comparative conclusions or open `EX-IF0`, passive
