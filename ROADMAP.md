...
не должны трактоваться как ещё не выполненный план `v1.0.0`.

### R0 — публикация `v1.0.0`

1. синхронизировать публичную поверхность репозитория с финальной диссертацией;
2. проверить единый version/citation/release contract;
3. собрать source archive и финальный 99-страничный PDF из exact release commit;
4. зафиксировать commit/tree и SHA-256 assets в release manifest;
5. создать annotated tag `v1.0.0` и immutable GitHub Release.
