...
основные приближения и кандидаты с предсказанием и коррекцией.
...
Объединить результаты Stage 1/2, диагностики Stage 3A и последующих
исследований локальности и ускорения; подготовить пакеты воспроизведения
и независимое воспроизведение в чистой среде.
