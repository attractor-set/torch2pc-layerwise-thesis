...
Машиночитаемый execution request и фактический runtime preflight теперь
зафиксированы, но отдельная authorization отсутствует; выполнение на запечатанном источнике и
...
| Запрос и runtime preflight описательного анализа | `v1` frozen; authorization отсутствует, execution закрыт |
