...
описательного анализа; утверждения о превосходстве и переход к `EX-IF0` не
разрешены.
...
assets. Публикация не разрешает утверждения о превосходстве, `EX-IF0`,
`A11-OFF0`, `A11-OFF1`, predictor, QWake-PC или test split. Следующий допустимый
переход — отдельная фиксация протокола `EX-IF0`; выполнение рекурсивных
агрегатов остаётся закрытым.
