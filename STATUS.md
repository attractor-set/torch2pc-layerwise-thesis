...
внешним seal с receipt и audit package. Output теперь зафиксирован как
репозиторные доказательные материалы, но публикация результатов, утверждения о
превосходстве и переход к `EX-IF0` не разрешены.
...
| Описательный анализ сопоставленного профилирования | единственная попытка выполнена; 18 файлов проверены, audit и внешний seal зафиксированы; публикация закрыта |
...
После однократного анализа, независимого audit и output-sealing PR граница остаётся закрытой для публикации:
