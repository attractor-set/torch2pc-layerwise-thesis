...
Одноразовая production callsite материализации финального подтверждения
завершена. Её разрешение потреблено, подтверждение выпущено и проверено, а
повтор запрещён. Постоянный lease v2, терминальная квитанция хоста и runtime
output отсутствуют. Поэтому этот evidence-пакет не является успешным
