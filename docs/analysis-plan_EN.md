...
does not open result computation. The implemented [runtime](glossary_EN.md#term-runtime) [preflight layer](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/experiments/planned/STAGE3B-MATCHED-DESCRIPTIVE-ANALYSIS-RUNTIME-PREFLIGHT_EN.md) checks identities and structural integrity; the actual runtime preflight and a separate [authorization](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/experiments/planned/STAGE3B-MATCHED-DESCRIPTIVE-ANALYSIS-EXECUTION-AUTHORIZATION_EN.md) were frozen before execution. The single [attempt](glossary_EN.md#term-attempt) completed; the exact output passed independent audit and is frozen through an external [seal](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/experiments/planned/STAGE3B-MATCHED-DESCRIPTIVE-ANALYSIS-OUTPUT-SEAL_EN.md). Generated metadata is not rewritten: the external seal establishes evidence status while publication remains closed.
