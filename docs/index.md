...
Документация фиксирует планы, наблюдения, решения и ограничения. Она не является
местом для утверждений, не связанных с зарегистрированным экспериментом.

Текущий publication state:
...
- [Текущий статус](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/STATUS.md)
- [Дорожная карта](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/ROADMAP.md)
