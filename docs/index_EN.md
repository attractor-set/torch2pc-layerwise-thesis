...
The documentation records plans, observations, decisions, and limitations. It
does not treat unregistered statements as empirical results.

Current publication state:

- Stage 1/2 are complete;
- Stage 3A diagnostics/statistics publication is complete;
- Stage 3B B0 execution, validation, sealing, evidence publication, and
  statistical and engineering analysis publication are complete;
- the full Stage 3B program remains incomplete;
- the next stage is the B1/B2 candidate-specific numerical equivalence gates.

Core documents:

- [Current status](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/STATUS_EN.md)
- [Roadmap](https://github.com/attractor-set/torch2pc-layerwise-thesis/blob/main/ROADMAP_EN.md)
