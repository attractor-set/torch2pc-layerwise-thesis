...
The documentation connects the research question, protocol, execution,
evidence, and bounded findings. Plans remain separate from observations, and
published results always include their scope and artifact provenance.
...
- Stage 3B B0 canonical execution, validation, integrity sealing, and evidence
...
- the next stage is candidate-specific numerical-equivalence testing for B1
  and B2.
...
3. Protocols and preregistration define rules before execution.
4. Result directories and reports record observations after execution.
