...
принимать решение о прекращении части вычисления до его штатного завершения. Для перехода
...
состояний относительно требуемого действия, глобальную достаточность
диагностического представления и более узкую селективную достаточность правила
...
зафиксированной целостностью предтерминальные исходы, для которых раннее действие
допустимо относительно задачи; можно ли на зафиксированной калибровочной
поверхности селективно распознавать ненулевое их подмножество по состоянию,
...
исходы класса \texttt{EARLY\_ADMISSIBLE}, а ненулевая селективная распознаваемость
их подмножества по состоянию до действия с нулём наблюдавшихся опасных принятий
...
для которых раннее действие допустимо относительно задачи, и ненулевой
...
PC-TREF defines task-relative state equivalence, a global criterion of
diagnostic-representation sufficiency, and a narrower action-selective
...
contains preterminal outcomes for which early termination is task-admissible,
...
completed without retries. In QWake-FP, the sealed surface contained preterminal outcomes for which
early termination was task-admissible, and non-zero selective pre-action
recognizability with zero observed dangerous accepts was found within the frozen
family of 2,625 scalar policies on 756 calibration records: 264 policies had
non-zero coverage with zero dangerous accepts, and the highest-coverage policy
among candidates with zero observed dangerous accepts covered 216 of 756
calibration records (28.57\%). No policy achieved positive aggregate net
saving under the frozen full decision-cost accounting. The full cost assigned
to that highest-coverage zero-danger candidate was overwhelmingly
observer-dominated,
...
recognizer. The dissertation therefore supports the presence of preterminal outcomes for
which early termination is task-admissible and non-zero selective pre-action
recognizability with zero observed dangerous accepts on the frozen calibration
surface, rejects the existence of a policy with zero observed dangerous accepts,
